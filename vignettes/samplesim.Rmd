...
```{r, eval = FALSE, echo = TRUE}
# Get the location of the dataset
mix.filename <- system.file(
  path    = "external",
  file    = "foxes_consumer.csv",
  package = "samplesim"
)
...
```{r, eval = FALSE, echo = TRUE}
# Get the location of the dataset
sources.filename <- system.file(
  path    = "external",
  file    = "foxes_sources.csv",
  package = "samplesim"
)
...
```{r, eval = TRUE, echo = FALSE}
# Get the location of the dataset
discr.filename <- "data/foxes_discrimination.csv"
...
```{r, eval = FALSE, echo = TRUE}
# Get the location of the dataset
discr.filename <- system.file(
  path    = "external",
  file    = "foxes_discrimination.csv",
  package = "samplesim"
)
...
If you prefer you can also used the `MixSIAR::plot_data()`. If your data make sense, let's move forward!
